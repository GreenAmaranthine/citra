...
- You have provided the log. if Citra crashes when starting, upĺoad User Directory/log.txt, if not, upload File -> Open User Directory -> log.txt. if it's empty, change log filter to *:Info.
- Please also provide:
