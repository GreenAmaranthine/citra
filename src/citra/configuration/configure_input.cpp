...
#include "citra/configuration/configure_input.h"
#include "citra/configuration/configure_motion_touch.h"
...
void ConfigureInput::OnNewProfile() {
...
void ConfigureInput::OnDeleteProfile() {
...
void ConfigureInput::OnRenameProfile() {
