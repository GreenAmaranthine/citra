...
void LoadBootromKeys() {
    ...
    const std::string filepath{FileUtil::GetUserPath(D_SYSDATA_IDX) + BOOTROM9};
...
void LoadBootromKeys() {
    ...
    // Some of the normal keys retrieved here aren't used/valid and need to get overwritten
    // by other methods.
