...
void Wrap() {
    u32 retval{func(Param(0), (((s64)Param(3) << 32) | Param(2))).raw};
...
void Wrap() {
    s64 param1{static_cast<s64>(((u64)Param(3) << 32) | Param(2))};
    s64 param2{static_cast<s64>(((u64)Param(4) << 32) | Param(1))};
...
void Wrap() {
    Kernel::Handle param_1{};
    Kernel::Handle param_2{};
